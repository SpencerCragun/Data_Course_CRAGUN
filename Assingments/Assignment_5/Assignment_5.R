...
It set boundaries on the x and y axis

p + coord_cartesian(xlim=c(0,0.1), ylim=c(0, 1000000)) # how is this different?
It gives a closer look on the graph.
...
# We change the size and color of points by adding code into the geom_point function, as well as changed the color
# of the linear model by adding a color function into the geom_smooth.
